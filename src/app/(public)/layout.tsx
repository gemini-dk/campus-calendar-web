...
export default function PublicLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex h-screen w-full flex-col bg-slate-50">
      <header className="relative z-40 w-full flex-shrink-0 border-b border-slate-200 bg-white/95 text-slate-900 shadow-[0_8px_30px_rgba(15,23,42,0.08)] backdrop-blur">
        <div className="mx-auto flex h-20 w-full max-w-6xl items-center gap-6 px-4">
          ...
          <div className="ml-auto flex h-16 w-fit items-center gap-4">
