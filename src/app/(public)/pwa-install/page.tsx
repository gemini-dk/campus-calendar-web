  ...
  return (
    <main className="flex min-h-screen w-full flex-1 bg-gradient-to-b from-sky-50 via-white to-white">
      <div className="flex w-full justify-center px-4 py-12">
        <article className="flex w-full max-w-[720px] flex-col gap-10 rounded-3xl border border-blue-200/60 bg-white p-10 text-slate-900 shadow-[0_24px_60px_rgba(148,163,184,0.25)]">
